...
Message.create(body: "The first message of Pedro", user_id: 1)
Message.create(body: "The first message of Matheus Martins", user_id: 2)
Message.create(body: "The first message of Mateus Sobral", user_id: 3)
Message.create(body: "The first message of Renan", user_id: 4)
Message.create(body: "The first message of Laércio", user_id: 5)
Message.create(body: "The first message of Robson", user_id: 6)
